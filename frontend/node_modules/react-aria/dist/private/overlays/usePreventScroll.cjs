...
$parcel$export(module.exports, "usePreventScroll", function () { return $b5daf4744c764686$export$ee0f7cc6afcd1c18; });
/*
...
let $b5daf4744c764686$var$restore;
function $b5daf4744c764686$export$ee0f7cc6afcd1c18(options = {}) {
    let { isDisabled: isDisabled } = options;
    (0, $429333cab433657c$exports.useLayoutEffect)(()=>{
        if (isDisabled) return;
        $b5daf4744c764686$var$preventScrollCount++;
        if ($b5daf4744c764686$var$preventScrollCount === 1) {
            if ((0, $d0b4a781cf26e80b$exports.isIOS)() && (0, $d0b4a781cf26e80b$exports.isWebKit)()) $b5daf4744c764686$var$restore = $b5daf4744c764686$var$preventScrollMobileWebKit();
            else $b5daf4744c764686$var$restore = $b5daf4744c764686$var$preventScrollStandard();
        }
        return ()=>{
            $b5daf4744c764686$var$preventScrollCount--;
            if ($b5daf4744c764686$var$preventScrollCount === 0) $b5daf4744c764686$var$restore();
        };
    }, [
        isDisabled
    ]);
...
function $b5daf4744c764686$var$preventScrollMobileWebKit() {
    ...
    let onTouchStart = (e)=>{
        ...
        scrollable = (0, $c3942aba3ca10757$exports.isScrollable)(target) ? target : (0, $d865e4ff74ef4a73$exports.getScrollParent)(target, true);
    ...
    let nonce = (0, $a9ae3cc70c0e2090$exports.getNonce)();
...
@layer {
  * {
    ...
    let onBlur = (e)=>{
        ...
        if (relatedTarget && (0, $d74c59468d7890a7$exports.willOpenKeyboard)(relatedTarget)) {
            // Focus without scrolling the whole page, and then scroll into view manually.
            relatedTarget.focus({
                preventScroll: true
            });
            $b5daf4744c764686$var$scrollIntoViewWhenReady(relatedTarget, (0, $d74c59468d7890a7$exports.willOpenKeyboard)(target));
...
function $b5daf4744c764686$var$scrollIntoViewWhenReady(target, wasKeyboardVisible) {
    if (wasKeyboardVisible || !$b5daf4744c764686$var$visualViewport) // If the keyboard was already visible, scroll the target into view immediately.
    $b5daf4744c764686$var$scrollIntoView(target);
    else // Otherwise, wait for the visual viewport to resize before scrolling so we can
    // measure the correct position to scroll to.
    $b5daf4744c764686$var$visualViewport.addEventListener('resize', ()=>$b5daf4744c764686$var$scrollIntoView(target), {
        once: true
    });
}
function $b5daf4744c764686$var$scrollIntoView(target) {
    let root = document.scrollingElement || document.documentElement;
    let nextTarget = target;
    while(nextTarget && nextTarget !== root){
        // Find the parent scrollable element and adjust the scroll position if the target is not already in view.
        let scrollable = (0, $d865e4ff74ef4a73$exports.getScrollParent)(nextTarget);
        if (scrollable !== document.documentElement && scrollable !== document.body && scrollable !== nextTarget) {
            let scrollableRect = scrollable.getBoundingClientRect();
            let targetRect = nextTarget.getBoundingClientRect();
            if (targetRect.top < scrollableRect.top || targetRect.bottom > scrollableRect.top + nextTarget.clientHeight) {
                let bottom = scrollableRect.bottom;
                if ($b5daf4744c764686$var$visualViewport) bottom = Math.min(bottom, $b5daf4744c764686$var$visualViewport.offsetTop + $b5daf4744c764686$var$visualViewport.height);
