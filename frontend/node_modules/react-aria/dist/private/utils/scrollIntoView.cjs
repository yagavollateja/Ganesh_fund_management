var $e2a63525475bbd9f$exports = require("./getScrollParents.cjs");
...
$parcel$export(module.exports, "scrollIntoView", function () { return $9a1324d6ffd8bbb0$export$53a0910f038337bd; });
$parcel$export(module.exports, "scrollRectIntoView", function () { return $9a1324d6ffd8bbb0$export$f064fd83a2c6e9ca; });
$parcel$export(module.exports, "scrollIntoViewport", function () { return $9a1324d6ffd8bbb0$export$c826860796309d1b; });
/*
...
function $9a1324d6ffd8bbb0$export$53a0910f038337bd(scrollView, element, opts = {}) {
    if (scrollView === element) return;
    let target = element.getBoundingClientRect();
    $9a1324d6ffd8bbb0$export$f064fd83a2c6e9ca(scrollView, element, target, opts);
}
function $9a1324d6ffd8bbb0$export$f064fd83a2c6e9ca(scrollView, element, target, opts = {}) {
    ...
    if ((0, $d0b4a781cf26e80b$exports.isIOS)() && (0, $d0b4a781cf26e80b$exports.isWebKit)() || viewStyle.direction === 'ltr') scrollPortRight -= scrollBarWidth;
...
function $9a1324d6ffd8bbb0$export$c826860796309d1b(targetElement, opts = {}) {
    ...
    if (targetElement && targetElement.isConnected) {
        ...
        if (!isScrollPrevented) {
            ...
            let scrollParents = (0, $e2a63525475bbd9f$exports.getScrollParents)(targetElement, true);
            for (let scrollParent of scrollParents)$9a1324d6ffd8bbb0$export$53a0910f038337bd(scrollParent, targetElement);
            let { left: newLeft, top: newTop } = targetElement.getBoundingClientRect();
            // Account for sub pixel differences from rounding
            if (Math.abs(originalLeft - newLeft) > 1 || Math.abs(originalTop - newTop) > 1) {
...
//# sourceMappingURL=scrollIntoView.cjs.map
